package com.util.ui.scrollbar {
  ...
  public class LRScrollerPanel extends Sprite {
    ...
    public function appendElements(arr:Array):Array{
      var result:Array = [];
      for each (var data:LRScrollerElement in arr) {
        result.push(appendElement(data));
      }
      return result;
    }
    public function appendElement(ele:LRScrollerElement):LRScrollerElement{
